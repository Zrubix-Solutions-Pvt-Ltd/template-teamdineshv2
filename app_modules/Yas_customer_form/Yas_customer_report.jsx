...
export var config = {
  name: "Yas Customer Report",
  // Actions configuration
  view_id: "yas_customer_view_id",//table/pivot
  module_id: "Z9181908335641762521017559",
  form: "Yas_customer_form",
  ...
  fields: [
    ...
    { name: "Credit Limit", link_name: "credit_limit", type: "decimal", display: true, section: "All_fields", bulk_edit: true, placeholder: "Enter credit limit" },
    { name: "Referral Source", link_name: "referral_source", type: "text", display: true, section: "All_fields", bulk_edit: true, placeholder: "Enter referral source" },
    ...
    { name: "Follow-up Date", link_name: "follow_up_date", type: "date", display: true, section: "All_fields", bulk_edit: true, placeholder: "Select follow-up date" },
    { name: "Follow-up Remarks", link_name: "follow_up_remarks", type: "textarea", display: true, section: "All_fields", bulk_edit: true, placeholder: "Enter follow-up remarks" },
    ...
    { name: "Occasion Reminders", link_name: "occasion_reminders", type: "textarea", display: true, section: "All_fields", bulk_edit: true, placeholder: "Enter occasion reminders" },
    { name: "Occupation / Business Name", link_name: "occupation_business_name", type: "text", display: true, section: "All_fields", bulk_edit: true, placeholder: "Enter occupation or business name" },
    { name: "Business Type / Industry", link_name: "business_type_industry", type: "text", display: true, section: "All_fields", bulk_edit: true, placeholder: "Enter business type or industry" },
    { name: "Office Address", link_name: "office_address", type: "textarea", display: true, section: "All_fields", bulk_edit: true, placeholder: "Enter office address" },
    { name: "GST Number / PAN Number", link_name: "gst_pan_number", type: "text", display: true, section: "All_fields", bulk_edit: true, placeholder: "Enter GST or PAN number" },
    { name: "Website or Social Media Links", link_name: "website_social_links", type: "text", display: true, section: "All_fields", bulk_edit: true, placeholder: "Enter website or social media links" },
  ],
