...
export var config = {
  name: "All Role Master Report",
  // Actions configuration
  view_id: "2569174000006872334",//table/pivot
  module_id: "Z9181908335641762521017555",
  form: "Role_master_form",
  form_name: "Role Master Form",
  columns: ["record_id", "role_name"],
  actions: [
    {
      key: 'edit',
      label: 'Edit',
  ...
  fields: [
    { name: "Record ID", link_name: "record_id", type: "text", display: true, section: "Details", bulk_edit: true },
    { name: "Role ID", link_name: "role_id", type: "text", display: true, section: "Details", bulk_edit: true },
    { name: "Role Name", link_name: "role_name", type: "text", display: true, section: "Details", bulk_edit: true },
    { name: "Description", link_name: "description", type: "textarea", display: true, section: "Details", bulk_edit: false },
    { name: "Status", link_name: "status", type: "dropdown", display: true, section: "Details", bulk_edit: true, options: ["active^^Active", "inactive^^Inactive"] },
    { name: "Assigned By", link_name: "assigned_by", type: "text", display: true, section: "Details", bulk_edit: true },
    { name: "Assigned Date", link_name: "assigned_date", type: "datetime", display: true, section: "Details", bulk_edit: true },
    { name: "Expiry Date", link_name: "expiry_date", type: "datetime", display: true, section: "Details", bulk_edit: true },
  ],
