...
export const config = {
  ...
  view_id: "2569174000007009251",//table/pivot
  ...
  fields: [
    ...
    { name: "Name", link_name: "name", type: "textbox", display: true, section: "All_fields", bulk_edit: true, placeholder: "Enter name" },
    { name: "Number", link_name: "number", type: "phone", display: true, section: "All_fields", bulk_edit: true, placeholder: "Enter phone number" },
    { name: "Email ID", link_name: "email_id", type: "email", display: true, section: "All_fields", bulk_edit: true, placeholder: "Enter email" },
    { name: "Caller Type", link_name: "caller_type", type: "radio", display: true, section: "All_fields", bulk_edit: true, placeholder: "Select caller type", options: ["bank_staff^^Bank Staff", "lh_staff^^LH Staff"] },
    { name: "EMP ID", link_name: "emp_id", type: "textbox", display: true, section: "All_fields", bulk_edit: true, placeholder: "Enter employee ID" },
    { name: "Designation", link_name: "designation", type: "textbox", display: true, section: "All_fields", bulk_edit: true, placeholder: "Enter designation" },
    { name: "Branch", link_name: "branch", type: "textbox", display: true, section: "All_fields", bulk_edit: true, placeholder: "Enter branch" },
    { name: "Bank Name", link_name: "bank_name", type: "dropdown", display: true, section: "All_fields", bulk_edit: true, placeholder: "Select bank", options: ["sbi^^State Bank of India", "hdfc^^HDFC Bank", "icici^^ICICI Bank", "axis^^Axis Bank"], other: true },
    { name: "Product name", link_name: "product_name", type: "textbox", display: true, section: "All_fields", bulk_edit: true, placeholder: "Enter product name" },
  ],
