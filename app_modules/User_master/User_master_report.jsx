...
export var config = {
  name: "All User Master Report",
  // Actions configuration
  view_id: "2569174000006873161",//table/pivot
  module_id: "Z9187786608481763533355093",
  form: "User_master_form",
  form_name: "User Master Form",
  columns: ["record_id", "user_name"],
  actions: [
    {
      key: 'edit',
      label: 'Edit',
  ...
  fields: [
    { "section": "details", "type": "text", "link_name": "record_id", "name": "Record ID", "display": true, "bulk_edit": true },
    { "section": "details", "type": "text", "link_name": "user_name", "name": "User Name", "display": true, "bulk_edit": true },
    { "section": "details", "type": "lookup", "link_name": "role", "name": "Role", "display": true, "bulk_edit": true, "report": "Role_master_report" },
    ...
    { "section": "details", "type": "date", "link_name": "dob", "name": "Date of Birth", "display": true, "bulk_edit": true },
    { "section": "details", "type": "dropdown", "link_name": "gender", "name": "Gender", "display": true, "bulk_edit": true, "options": ["male^^Male", "female^^Female"] },
    { "section": "details", "type": "dropdown", "link_name": "department", "name": "Department", "display": true, "bulk_edit": true, "options": ["hr^^HR", "it^^IT", "finance^^Finance"] },
    { "section": "details", "type": "dropdown", "link_name": "designation", "name": "Designation", "display": true, "bulk_edit": true, "options": ["manager^^Manager", "developer^^Developer", "analyst^^Analyst"] },
    { "section": "details", "type": "textarea", "link_name": "address", "name": "Address", "display": true, "bulk_edit": true },
    { "section": "details", "type": "textarea", "link_name": "profile_picture", "name": "Profile Picture", "display": true, "bulk_edit": true },
    { "section": "details", "type": "datetime", "link_name": "last_login", "name": "Last Login", "display": true, "bulk_edit": true },
    { "section": "details", "type": "checkbox", "link_name": "has_mobile_access", "name": "Has Mobile Access", "display": true, "bulk_edit": true },
    { "section": "details", "type": "checkbox", "link_name": "has_web_access", "name": "Has Web Access", "display": true, "bulk_edit": true },
    { "section": "details", "type": "checkbox", "link_name": "has_multiple_device", "name": "Has Multiple Device", "display": true, "bulk_edit": true },
    { "section": "details", "type": "textarea", "link_name": "zems_url", "name": "Zems URL", "display": true, "bulk_edit": true },
    { "section": "details", "type": "textarea", "link_name": "development_api_url", "name": "Development API URL", "display": true, "bulk_edit": true },
    { "section": "details", "type": "textarea", "link_name": "live_api_url", "name": "Live API URL", "display": true, "bulk_edit": true },
    { "section": "details", "type": "text", "link_name": "user_id", "name": "User ID", "display": true, "bulk_edit": true },
    { "section": "details", "type": "number", "link_name": "time_per_capture", "name": "Time Per Capture", "display": true, "bulk_edit": true },
    { "section": "details", "type": "number", "link_name": "time_per_send", "name": "Time Per Send", "display": true, "bulk_edit": true },
