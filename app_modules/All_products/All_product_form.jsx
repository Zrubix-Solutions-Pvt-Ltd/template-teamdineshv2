...
config.edit_form_headers.main_form.form_headers = [
  { "section": "All_fields", "type": "textbox", "link_name": "product_id", "name": "Product ID", "placeholder": "Enter product ID", "row": 1, "col": 1 },
  { "section": "All_fields", "type": "textbox", "link_name": "product_name", "name": "Product Name", "placeholder": "Enter client type", "row": 1, "col": 2, options: ["lead^^Lead", "company^^Company", "contact^^Contact"], other: true },
...
export default function All_fields_form({
  ...
  ignoreUrlRecord = false,
  preventNavigateOnSave = false,
}) {
  return (
    <All_forms
      config={config}
      ...
      show={show}
      ignoreUrlRecord={ignoreUrlRecord}
      preventNavigateOnSave={preventNavigateOnSave}
    />
  );
}
